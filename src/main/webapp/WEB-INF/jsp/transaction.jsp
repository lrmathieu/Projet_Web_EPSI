...
<form action="<c:url value="/transactions"/>" method="POST">
	...
	<input name="transactionRecipeInteger" value="<c:out value="${param['transactionRecipeInteger']}"/>">,
	<input name="transationRecipeFraction" size="2" maxlength="2" value="<c:out value="${param['transationRecipeFraction']}"/>"><br><br>
